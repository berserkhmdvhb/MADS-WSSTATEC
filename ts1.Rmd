...
Based on the results from the forecast, we have:
AIC=4789.42   AICc=4789.5   BIC=4819.41

Now I manually compute RMSE between prediction and test data
```{r}
...
rmse(as.numeric(prediction),as.numeric(ts_test_meantemp))
```
